  ...
  return (
    <div className="px-7 py-6">
      ...
      <div className="w-full border-b-2 border-b-secondary my-2">
            <h4 className="my-8 h-32 overflow-y-auto p-2 border border-gray-300 rounded-lg">
            {specialNote}
            </h4>
            ...
            <div className="flex mt-4">
                <div className="w-1/2 pr-2">
                    ...
                    min={1}
                    max={5}
                    className="w-full  border border-gray-100 rounded-lg p-2.5"
                    />
                </div>
                <div className="w-1/2 pl-2">
